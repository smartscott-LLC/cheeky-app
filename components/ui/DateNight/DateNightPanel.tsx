  ...
  return (
    <div className="rounded-xl border border-club/30 bg-zinc-900/80 p-4">
      <div className="flex items-center justify-between">
        ...
        <span
          className={`rounded-full px-2.5 py-0.5 text-xs font-bold ${
            left <= 10 ? 'bg-club/20 text-club' : 'bg-zinc-800 text-zinc-300'
          }`}
        >
          {mm}:{ss}
        </span>
            ...
            <button
              ...
              className={`rounded-lg border px-3 py-2 text-left text-sm transition ${
                picked
                  ...
                  : 'border-zinc-700 text-zinc-200 hover:border-club/50'
              }`}
            >
      ...
      <div className="mt-3 flex items-center justify-between text-xs">
        {myPick === null ? (
          <p className="text-zinc-500">Pick an answer — then talk it out.</p>
        ) : disagree ? (
