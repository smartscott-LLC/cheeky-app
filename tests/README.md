...
| `tests/ai-probe.live.test.mjs`     | How one AGNES key survives a concurrent burst — successes / 429s / failures / latency / token usage                                                                                                                                                                                                                                                                                                                                                                                        | `AGNES_API_KEY`                                              | `PROBE_CONCURRENCY` (default 8)                                                                     |
...
- Token-engine tests seed tokens and mint codes with a `test:` note and a
  ...
  removes every trace.
- The AI probe spends a few cents of AGNES usage per run — keep
