-- HOT FIX: Add COALESCE to prevent NULL counts in taskbar_state RPC.
-- Without COALESCE, greatest(0, NULL) returns NULL, causing "undefined" on the bar.
...
begin
  ...
  select
    ...
    -- Matchmaker: ensure non-null with COALESCE
    coalesce(greatest(0, (
    ...
    -- Free event allowances: COALESCE prevents NULL from flowing through
