...
const [secret, userId, endpoint = 'https://smartscott.online/api/webhooks'] = process.argv.slice(2);
if (!secret || !userId) {
  console.error('Usage: node scripts/test-webhook-duplicate.mjs <whsec> <userId> [endpoint]');
  process.exit(1);
}
